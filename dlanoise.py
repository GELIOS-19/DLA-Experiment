...
def main():
        ...
        images = perform_dla(seed=2, initial_size=50, end_size=1000, initial_density_threshold=0.1, density_falloff_rate=2, use_concurrent_walkers=False, upscale_factor=2, upscale_jitter=1)
